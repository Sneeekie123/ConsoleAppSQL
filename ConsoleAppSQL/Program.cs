...
using ConsoleAppSQL.Repositories;
...
var builder = Host.CreateDefaultBuilder().ConfigureServices(services =>
{
    ...
    services.AddDbContext<DataContext>(x => x.UseSqlServer(@"Data Source=(LocalDB)\MSSQLLocalDB;AttachDbFilename=C:\Projects\ConsoleAppSQL\ConsoleAppSQL\Data\sqldatabase.mdf;Integrated Security=True;Connect Timeout=30"));
